...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "3-star pure vegetarian family & business hotel in Ner Chowk, Mandi, Himachal Pradesh. Mountain-view rooms, Jain food, free Wi-Fi & parking. Book: +91 97366 00024." },
      { name: "author", content: "CM Palace Hotel" },
